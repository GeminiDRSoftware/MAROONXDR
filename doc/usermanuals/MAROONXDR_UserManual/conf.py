...
exclude_patterns = [
    ...
    'Thumbs.db',
    '.DS_Store',
    # generated fragments are pulled in via `.. include::` by the
    # hand-written pages; they are not standalone documents
    'primitives/generated_doc',
    'recipes/generated_doc',
]
