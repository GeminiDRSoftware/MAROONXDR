...
logutils.config(file_name="test_reduced_wavecal_v2.log", mode="debug", stomp=True)
log = logutils.get_logger("test_reduced_wavecal_v2.log")
log.setLevel("DEBUG")
...
@pytest.mark.parametrize(
    'matching_filenames',
    [
        ('20250717T163124Z_DEEEE_b_0010_wavecal.fits', '20250717T163124Z_DEEEE_b_0010.hdf'),
        ('20250717T163124Z_DEEEE_r_0004_wavecal.fits', '20250717T163124Z_DEEEE_r_0004.hdf'),
    ],
)
